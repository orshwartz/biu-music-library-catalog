...
<table border=1 bordercolor=black align=center width=500 class='dataTable'>
    ...
    <tr>
	    <td align=center>
    	  	<input type=text name="item_no" value="<?php echo $item_no;?>">
        </td>
	...
	<tr>
		<td align=center>
			<input type=text <?php if ($action == "displayitem") echo "readonly" ?> name="composer" value="<?php echo $composer;?>" dir=ltr>
		</td>
		<td align=right>
	...
	<tr>
		<td align=center width="50%">
			<input type=text <?php if ($action == "displayitem") echo "readonly" ?> name="composer2" value="<?php echo $composer2;?>" dir=rtl>
		</td>
		<td align=right>
			<?php if ($action != "displayitem")
	...
	<tr>
		<td align=center>
			<input type=text <?php if ($action == "displayitem") echo "readonly" ?> name="composition_formal_name" value="<?php echo $composition_formal_name;?>" dir=ltr>
		</td>
		<td align=right>
			<?php if ($action != "displayitem")
	...
	<tr>
		<td align=center>
			<input type=text name="publisher" value="<?php echo $publisher;?>" dir=ltr>
		</td>
		<td align=right>
	...
	<tr>
		<td align=center>
			<input type=text name="publisher_place" value="<?php echo $publisher_place;?>" dir=ltr>
		</td>
	...
	<tr>
		<td align=center>
        		<input type=text name="year" value="<?php echo $year;?>" dir=ltr>
		</td>
				...
				<tr>
					<td align=center colspan=2>
						<table border=0 bordercolor=black class='dataTable' align=center>
							<tr>
								<td align=center>
									<input type=text name="solist" value="<?php echo $solist;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="solist2" value="<?php echo $solist2;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="solist3" value="<?php echo $solist3;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
                             ...
                             <tr>
								<td align=center>
									<input type=text name="performance_group" value="<?php echo $performance_group;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="performance_group2" value="<?php echo $performance_group2;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="performance_group3" value="<?php echo $performance_group3;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="orchestra" value="<?php echo $orchestra;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="orchestra2" value="<?php echo $orchestra2;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="orchestra3" value="<?php echo $orchestra3;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="conductor" value="<?php echo $conductor;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="conductor2" value="<?php echo $conductor2;?>" dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
							...
							<tr>
								<td align=center>
									<input type=text name="conductor3" value="<?php echo $conductor3;?>"  dir=ltr>
								</td>
								<td align=right>
									<table border=0 bordercolor=black align=center width=100% class="dataTable">
										<tr>
    ...
    <tr>
		<td align=center>
			<textarea name="notes" value="<?php echo $notes;?>" scrolling=no rows='6' cols='40' wrap='soft' dir=ltr style='width: 100%;overflow:auto'><?php echo $notes;?></textarea>
		</td>
	...
	<tr>
		<td align=center>
			<input type=text name="subject" value="<?php echo $subject;?>" dir=ltr>
		</td>
		<td align=right>
			<table border=0 bordercolor=black align=center width=100% class="dataTable">
				<tr>
