                ...
                if(col != "")
                {
                       ...
                       if ((code == "13") || (code == "14"))// if there are composer & composer2 and one of them was chosen a value.
                       {
                         ...
                         // case is different when there is only one field. (search)
                           ...
                           eval("opener.searchForm." + col + ".dir=\"" + "ltr" + "\";");
                           eval("opener.searchForm." + col + "2.value=\"" + my_add_slashes(id2) + "\";");
                           eval("opener.searchForm." + col + "2.dir=\"" + "rtl" + "\";");
                       }
        ...
        for($i = 0;$i < $num_rows;$i++) {
            ...
            if ($column == "composer") {
                ...
                if (($code == "6") ||	// 6 used in the search system and 23 in admin -
                    ...
                    echo "<td width=10% align=center> - </td>";
                    echo "<td dir=rtl><a href=\"javascript: chooseVal('" . $column . "','" . $code . "','" . get_php_string(addslashes($printValue)) . "', '" . $lang . "','" . get_php_string(addslashes($printValue2)) . "')\">" . get_php_string(stripslashes($printValue2)) . "</a></td>";
                }
                echo "</tr>";
                ...
                if ($lang == "heb") {
                    echo "<tr>";
                    echo "<td dir=rtl><a href=\"javascript: chooseVal('" . $column . "','" . $code . "','" . get_php_string(addslashes($printValue)) . "', '" . $lang . "')\">" . get_php_string(stripslashes($printValue)) . "</a></td>";
                    echo "</tr>";
                } else if ($lang == "en") {
                    echo "<tr>";
                    echo "<td dir=ltr><a href=\"javascript: chooseVal('" . $column . "','" . $code . "','" . get_php_string(addslashes($printValue)) . "', '" . $lang . "')\">" . get_php_string(stripslashes($printValue)) . "</a></td>";
                    echo "</tr>";
                }
            }
